...
Cada sesión o fuente de feedback se documenta en un archivo `YYYY-MM-DD-fuente.md` con:
...
3. Periódicamente, revisar los clústers para identificar patrones.
4. Las ideas que se repiten entre fuentes distintas son candidatas prioritarias a considerar.
