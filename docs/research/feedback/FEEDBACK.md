...
| Taxonomía | Pregunta que resuelve | Features | Sesiones de feedback |
|---|---|---|---|
...
| UX / Claridad | Usuario: ¿Por qué tengo que comprar tantos? | Cantidad intuitiva | 1 |
| Edición de deseos | Dueño: ¿Cómo enriquezco la descripción de un deseo? | Markdown, Tarjar | — |

## Features

| Feature / Idea | Ocurrencias | Fuentes |
|---|---|---|
| Contenido personalizado en lista (fotos) | 1 | camila |
| Sistema de sugerencias con aceptación/rechazo | 1 | camila |
| Notificación al aceptar sugerencia | 1 | camila |
| Sugerencia con adjuntos (link, foto) | 1 | camila |
| Mensaje de agradecimiento al asignarse un deseo | 1 | camila |
| Galería de fotos colaborativa con moderación | 1 | camila |
| Tipos de evento (cumpleaños, bautizo, etc.) | 1 | camila |
| Versatilidad (lista de útiles, propuestas, etc.) | 1 | camila |
