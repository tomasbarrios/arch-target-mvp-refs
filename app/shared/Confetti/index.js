...
export const Confetti = React.forwardRef(({ children, ...props }, ref) => {
    ...
    <div class="confetti-container">
      <div class="confetti">
        ...
        <i style="--speed: 24; --bg: pink" class="wavy-line">
          {" "}
        </i>
        ...
        <i style="--speed: 15; --bg: yellow" class="wavy-line">
          {" "}
        </i>
        ...
        <i style="--speed: 18; --bg: green" class="rectangle"></i>
        <i style="--speed: 37; --bg: red" class="dodecagram"></i>
        <i style="--speed: 23; --bg: pink" class="wavy-line">
          {" "}
        </i>
        ...
        <i style="--speed: 29; --bg: pink" class="wavy-line">
          {" "}
        </i>
        ...
        <i style="--speed: 18; --bg: green" class="rectangle"></i>
        <i style="--speed: 37; --bg: red" class="dodecagram"></i>
        <i style="--speed: 48; --bg: pink" class="wavy-line">
          {" "}
        </i>
        ...
        <i style="--speed: 25; --bg: white" class="square"></i>
        <i style="--speed: 18; --bg: green" class="rectangle"></i>
        <i style="--speed: 15; --bg: cyan" class="wavy-line">
          {" "}
        </i>
        <i style="--speed: 32; --bg: yellow" class="pentagram"></i>
        ...
        <i style="--speed: 37; --bg: red" class="dodecagram"></i>
        <i style="--speed: 37; --bg: pink" class="wavy-line">
          {" "}
        </i>
  ...
  `
  return (
    <div {...props} ref={ref} data-confetti
